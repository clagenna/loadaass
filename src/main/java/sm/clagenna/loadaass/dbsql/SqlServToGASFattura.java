...
public class SqlServToGASFattura extends SqlServBase {
  private static final Logger s_log           = LogManager.getLogger(SqlServToGASFattura.class);
  ...
  public SqlServToGASFattura(TagValFactory p_fact, DBConn p_con) {
    super(p_fact, p_con);
  }
