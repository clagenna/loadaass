...
public abstract class Valore {
  ...
  public Object getValore() throws ReadFattValoreException {
  ...
  public Object getValore(int rig) throws ReadFattValoreException {
    ...
    if ( !m_isArray)
      throw new ReadFattValoreException("Non e' un array");
    if (rig < 0 || rig >= valore.size())
      throw new ReadFattValoreException("Index out of bounds");
  ...
  public void setFieldName(String p_nam) throws ReadFattValoreException {
    if (m_fldNam != null && !m_fldNam.equals(p_nam))
      throw new ReadFattValoreException(String.format("Trying change name from \"%s\" with \"%s\"", m_fldNam, p_nam));
    m_fldNam = p_nam;
  }
