--
-- File generato con SQLiteStudio v3.4.4 su mer mag 29 17:44:16 2024
--
...
CREATE VIEW IF NOT EXISTS EELettureMensili AS
    SELECT te.NomeIntesta,
           ...
           le.TipoLettura,
           le.LettPrec,
           le.LettDtAttuale,-- strftime('%Y.%m',le.LettDtAttuale) as mmDtAttuale,
           le.LettAttuale,
           le.LettConsumo,
...
-- ,dbo.toAnnoMese(cs.dtFine) as dtFine-- ft.periodEffDtIniz-- ft.periodEffDtFine
...
CREATE VIEW IF NOT EXISTS GASLettureMensiliTipo AS
    SELECT NomeIntesta/* ,annoComp */,
           ...
           COALESCE(periodAccontoDtFine, periodEffDtFine, periodFattDtFine) AS dtFine/* ,periodAccontoDtFine */,
